...
## Type Ownership
Owns: `SpaceTemplate`, `SpaceInstance`, `SpaceConstraint`, `ConstraintMode` (enum), `Unit`, `Assembly`, `AggregateConstraint`, `GlobalLimit`, `Project`, `StorageCategory`, `InstallationConstraint`, `ValidityState` (enum).
