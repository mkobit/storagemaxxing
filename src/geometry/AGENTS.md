...
## Type Ownership
Owns: `Point2D`, `Point3D`, `Dimensions2D`, `Dimensions3D`, `Rect2D`, `Box3D`, `GridCoord`, `GridDimensions`, `Inches`, `Millimeters`, `AccessFace` (enum: top | front | top+front | all-sides), `GridUnit`.
