...
import { SpaceTypeIdSchema, InstallationConstraintSchema, DividerSchema, ObstacleSchema } from './BaseTypes.js';
...
}).readonly().refine(data => (data.w !== undefined && data.l !== undefined && data.h !== undefined) || data.footprint !== undefined, {
