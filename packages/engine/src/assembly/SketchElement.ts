...
export const createSketchRectangle = (id: SketchElementId, geometry: Rect2D): SketchRectangle => ({
  id,
  type: 'rectangle',
  geometry,
});

export const createSketchLine = (id: SketchElementId, geometry: Line2D): SketchLine => ({
  id,
  type: 'line',
  geometry,
});
